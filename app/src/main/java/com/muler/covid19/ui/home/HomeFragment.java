package com.muler.covid19.ui.home;
...
public class HomeFragment extends Fragment {
   private TextView textView, txthistorydet,txtdate1,txttravel2detail,txtdate2,txtLocation3ta;
    private HomeViewModel homeViewModel;
    SharedPreferences sharedpreferences;
    ProgressBar progressBar1,progressBar3,progressBar4,progressBar3state;
       ...
       // final TextView textView = root.findViewById(R.id.text_home);
        ...
        homeViewModel.getText().observe(this, new Observer<String>() {
            ...
            public void onChanged(@Nullable String s) {
                ...
                getPinfo("https://dmuit.abyssiniasoft.com/personal_info.php?imei="+imei);
                getTravelHistory("https://dmuit.abyssiniasoft.com/user_travel.php");
                getTravelHistory2("https://dmuit.abyssiniasoft.com/user_travel2.php");
              Warnings("https://dmuit.abyssiniasoft.com/get_warnings.php?imei="+imei);
