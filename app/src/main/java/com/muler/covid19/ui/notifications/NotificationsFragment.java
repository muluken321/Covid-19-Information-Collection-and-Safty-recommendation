package com.muler.covid19.ui.notifications;
...
import com.muler.covid19.ui.home.HomeFragment;
...
private  String Data_this = "Data_This";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        sharedpreferences = getActivity().getSharedPreferences(HomeFragment.MyPREFERENCESdb, Context.MODE_PRIVATE);
        sharedpreferencethis = getActivity().getSharedPreferences(Data_this, Context.MODE_PRIVATE);
         sharedpreferencescidimei = getActivity().getSharedPreferences(HomeFragment.MyPREFERENCESdb, Context.MODE_PRIVATE);
        notificationsViewModel.getText().observe(this, new Observer<String>() {
            @Override
            public void onChanged(@Nullable String s) {

                String MY_loc_data = MainActivity.sharedpreferences.getString("MY_loc_data","");
                String Report_et = NotificationsFragment.sharedpreferencethis.getString("Report_et","");
                String Re_warn = NotificationsFragment.sharedpreferencethis.getString("Reportetwarn","");
                String last14 = NotificationsFragment.sharedpreferencethis.getString("last14","");
                ...
                getData("https://dmuit.abyssiniasoft.com/get_data.php");

                Warnings("https://dmuit.abyssiniasoft.com/get_warnings.php?imei="+myImEi);

                Sammaryforteen("https://dmuit.abyssiniasoft.com/F_dayes.php?imei="+myImEi);
            }
        });
        return root;
    }
